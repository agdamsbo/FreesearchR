...
overview with focus on the basic functions.
...
*FIX* The exported MS Word documents prompts a warning. The codebase now
includes a fix, but it only works running locally, but was disabled.
